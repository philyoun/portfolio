...
- Section 7.4.2에서, 함수가 만들어질 때, 함수를 갖고 있는 env를 캡쳐(enclose)한다는 걸 배웠다. <br />
...
3개의 주요 functional programming tools(functional, function factories and function operators)중에서, function factories를 제일 덜 쓴다. <br />
...
![그림1](https://d33wubrfki0l68.cloudfront.net/66b438e96694794ea48f2acc27d43cd4d5998336/a401d/diagrams/function-factories/power-full.png)
...
![그림2](https://d33wubrfki0l68.cloudfront.net/80c8c044530ad592a173a20ae51ac9479e918888/8b4f9/diagrams/function-factories/power-simple.png)
