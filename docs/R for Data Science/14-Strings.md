...
<details> <summary>14.3.1.1 Exercises</summary> 1. 왜 다음의 각각은 <code>&lt;/code&gt;를 match하지 못하는지를 설명해봐라. : <code>""</code>, <code>"\\"</code>, <code>"\\"</code>

1.  <code>"'&lt;/code&gt;를 어떻게 match할 건지?
...
1.  어떤 패턴이 <code>......</code>라는 정규표현식에 match가 될지? 이걸 어떻게 string으로 표현할건지? <br /> (진짜 .) + any character + (진짜 .) + any character + (진짜 .) + any character 같은 정규표현식을 match가능.
...
<details> <summary>14.3.2.1 Exercises</summary> 1. <code>"$^$"</code> 이 자체를 match하고 싶다면? string 사이에 <code>$^$</code>가 있을수도 있는건데, 딱 이것만을 match하고 싶다면.
...
3번. 정확하게 3개의 알파벳으로 구성(<code>str\_length()</code> 쓰지 말고!)
...
해당이 되는 것들만 출력이 되길 원한다면, 위와 같이 <code>match = TRUE</code> 옵션을 넣으면 된다. </details>
...
![14.3.3-4](https://github.com/philyoun/portfolio/blob/master/docs/R%20for%20Data%20Science/14-Strings_files/14.3.3-4.png?raw=true) <br /> <br /> <br /> <br /> <details> <summary>14.3.3.1 Exercises</summary>
...
<br /> <br /> <br /> <br /> <details> <summary>14.3.4.1 Exercises</summary>
...
<br /> <br /> <br /> <br /> <details> <summary>14.3.5.1 Exercises</summary>
